...
class _PhoneVerificationScreenState extends ConsumerState<PhoneVerificationScreen>
  ...
  void _verifyOtp() {
    ...
    ref.read(phoneAuthProvider.notifier).verifyOtp(code);
  }
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<PhoneAuthState>(phoneAuthProvider, (previous, next) {
      if (next.error != null) {
        ...
        // Successful login! GoRouter's redirect logic will automatically push us to /home.
        // But let's also manually navigate just in case.
        context.go('/home');
      }
    });
                        ...
                        child: Column(
                          children: [
                            _ModernField(
                              ...
                              validator: (v) {
                                if (v == null || v.isEmpty) return 'Verification code is required';
